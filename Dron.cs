...
public class Dron : MonoBehaviour {
	...
	public void actualizarDronBtn () {
		mainScript.actualizarTabDronAtk ();
		mainScript.actualizarTabDronAtkToAdd ();
		mainScript.actualizarTabDronLevel ();
		mainScript.actualizarTabDronLevelCost ();
		mainScript.actualizarTabDronUnlockTxt ();
	...
	void passingVariablesToSave () {
		gameStatus.dronLevel = level;
		gameStatus.dronBaseAtk = atkBase;
		gameStatus.dronAtk = atk;
		gameStatus.dronLevelCostBase = levelCostBase;
		gameStatus.dronLevelCost = levelCost;
		gameStatus.dronAtkToAdd = atkToAdd;
	}
